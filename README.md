...
_See code: [dist/commands/compile.ts](https://github.com/rohan-ramakrishnan/javauc/blob/v2.1.1/dist/commands/compile.ts)_
...
_See code: [dist/commands/create-source-file.ts](https://github.com/rohan-ramakrishnan/javauc/blob/v2.1.1/dist/commands/create-source-file.ts)_
